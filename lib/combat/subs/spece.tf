/set hitlocs=(cialo|ogonek|prawe ramie|lewe ramie|pokryty twarda skora tulow|twarda glowe|kosmaty tulow|luskowate cialo|szponiaste rece|kosciane nogi|oslizgle cialo|lewa reke|prawa reke|lewa noge|prawa noge|glowe|korpus|nogi|tulow|leb|kudlate cialo|kamienna reke|kamienna noge|jedna z lian|okolice korzeni|tors|lepek|kudlate cielsko|prawa lape|lewa lape|metalowy korpus|pobruzdzona glowe|cienki szczekoczulek|kamienny korpus|plamiasta glowe|umiesnione prawe ramie|umiesnione lewe ramie|pysk|widmowe nogi|kudlate cialo|pysk)
...
/def -Fp100 -mregexp -t'Wykorzystujac brak broni u przeciwnika,(| blyskawicznie| w mgnieniu oka| z wyuczona wprawa) wyprowadzasz cios (.*) mierzac w (.*). Nieznacznie tracisz rownowage, gdy twoja bron ze swistem przecina powietrze po [^ ]+ udanym uniku.' my_str_spec_0_unik = \
  /substitute -p @{BCwhite}----> @{Cmagenta}[STR 0/5] @{Cwhite}ja probuje specowac @{Crgb053}%{P3} @{CWhite}(unik).
/def -Fp100 -mregexp -t'Wykorzystujac brak broni u przeciwnika,(| blyskawicznie| w mgnieniu oka| z wyuczona wprawa) wyprowadzasz cios (.*) mierzac w (.*). Wypracowane uderzenie zostaje jednak sparowane przez niego [^ ]+ [^ ]+ [^ ]+ tarcza.' my_str_spec_0_tarcza = \
  /substitute -p @{BCwhite}----> @{Cmagenta}[STR 0/5] @{Cwhite}ja probuje specowac @{Crgb053}%{P3} @{CWhite}(tarcza).
/def -Fp100 -mregexp -t'Wykorzystujac brak broni u przeciwnika,(| blyskawicznie| w mgnieniu oka| z wyuczona wprawa) wyprowadzasz cios (.*) mierzac w (.*). Wypracowanym uderzeniem trafiasz [^ ]+ w (.*), (pozostawiajac ledwie sinca|ledwie zahaczajac).' my_str_spec_1 = \
  /substitute -p @{BCwhite}----> @{Cmagenta}[STR 1/5] @{Cwhite}ja specuje @{Crgb053}%{P3}@{CWhite}.
/def -Fp100 -mregexp -t'Wykorzystujac brak broni u przeciwnika,(| blyskawicznie| w mgnieniu oka| z wyuczona wprawa) wyprowadzasz cios (.*) mierzac w (.*). Wypracowanym uderzeniem trafiasz [^ ]+ w (.*), (pozostawiajac krwawiace zadrapanie|lekko raniac).' my_str_spec_2 = \
  /substitute -p @{BCwhite}----> @{Cmagenta}[STR 2/5] @{Cwhite}ja specuje @{Crgb053}%{P3}@{CWhite}.
/def -Fp100 -mregexp -t'Wykorzystujac brak broni u przeciwnika,(| blyskawicznie| w mgnieniu oka| z wyuczona wprawa) wyprowadzasz cios (.*) mierzac w (.*). Wypracowanym uderzeniem trafiasz [^ ]+ w (.*), (pozostawiajac dluga, poszarpana rane|mocno raniac).' my_str_spec_3 = \
  /substitute -p @{BCwhite}----> @{Cmagenta}[STR 3/5] @{Cwhite}ja specuje @{Crgb053}%{P3}@{CWhite}.
/def -Fp100 -mregexp -t'Wykorzystujac brak broni u przeciwnika,(| blyskawicznie| w mgnieniu oka| z wyuczona wprawa) wyprowadzasz cios (.*) mierzac w (.*). Wypracowanym uderzeniem trafiasz [^ ]+ w (.*), (pozostawiajac gleboka rane z wystajacymi na wierzchu tkankami|bardzo mocno raniac).' my_str_spec_4 = \
  /substitute -p @{BCwhite}----> @{Cmagenta}[STR 4/5] @{Cwhite}ja specuje @{Crgb053}%{P3}@{CWhite}.
/def -Fp100 -mregexp -t'Wykorzystujac brak broni u przeciwnika,(| blyskawicznie| w mgnieniu oka| z wyuczona wprawa) wyprowadzasz cios (.*) mierzac w (.*). Wypracowanym uderzeniem trafiasz [^ ]+ w (.*), zadajac smiertelne obrazenia.' my_str_spec_5 = \
  /substitute -p @{BCwhite}----> @{Cmagenta}[STR 5/5] @{Cwhite}ja specuje @{Crgb053}%{P3}@{CWhite}.
