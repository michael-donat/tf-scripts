...
/eval /def -p200 -mregexp -t'Ostrym jak sztylet gornym szpikulcem sterczacym ze styliska misternego obosiecznego topora godzisz (.*) w (.*), spuszczajac [^ ]+ nieco krwi.' _misterny_plus_ja_kogos_2 = /substitute -p @{BCwhite}----> @{Cyellow}[Mister+ 2/7] @{BCwhite}specuje @{Cblue}%%{P1}@{Cwhite}.
