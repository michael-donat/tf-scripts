/def -mregexp -Fp2 -t'( i szybko przesuwa sie za ciebie, kryjac sie|Zrecznie zaslaniasz|Nie udaje ci sie zaslonic|Probujesz zaslonic|Na rozkaz .* (zaslaniasz|probujesz zaslonic)|Rzucasz sie na|Bezskutecznie rzucasz sie na)' _statusbar_trigger_cover = \
