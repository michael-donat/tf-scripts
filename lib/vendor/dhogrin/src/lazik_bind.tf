...
/alias n /set przeciwny=s
/alias s /set przeciwny=n
/alias e /set przeciwny=w
/alias w /set przeciwny=e
/alias nw /set przeciwny=se
/alias ne /set przeciwny=sw
/alias se /set przeciwny=nw
/alias sw /set przeciwny=ne
/alias u /set przeciwny=d
/alias d /set przeciwny=u
...
/lazikuj%;\
/purge _move_lazik_do%; \
/def _move_lazik_do=/go
