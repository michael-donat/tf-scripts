...
/def bronie_przydziel = \
 ...
 /elseif ({*}=/"*{miecz*|scimitar*|talwar*|szabl*|szabel*|schiavon*|poltorak*|sihill*|floret*|estok*|szamszir*|palasz*|tasak*|bulat*|koncerz*|nimsz*|kord*|flamberg*|espadon*|karabel*|katzbalger*|multon*|claymor*|rapier*}*")\
 ...
 /elseif ({*}=/"*{sztylet*|lewak*|katar*|navaj*|stilett*|pazur*|parazoni*|puginal*|dag*|noz*}*")\
 ...
 /elseif ({*}=/"*{runek*|halabard*|kij*|runke*|dard*|runki*|trojzab*|las*|dzid*|spis*|glewi*|naginat*|gizarm*|wloczni*|kosa|kosy|kose|cep*|drannach*|pike*|piki*|partyzan*|korsek*|ronkon*}*")\
