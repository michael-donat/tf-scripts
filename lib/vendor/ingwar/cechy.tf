; ## Linie dodane automagicznie   : tf_ver=1.1.4
; ## 
; ## Wersja pliku                 : 1.1.4
; ## Ostatnia zmiana pliku        : 2009-01-06 21:07:41
; ## Plik pobrany                 : 2009-01-06 21:08:05
...
/def _cechy_trigs = \
    ...
    /def -FPB -p4 -t' potezn' 				_cechy_set_str_7=/set ogolne_cechy_cecha1 7 %;\
    ...
    /def -p5 -PB -t'nadludzk' 				_cechy_set_brak_7=/set cechy_brakuje 10%%;/_cechy_liczenie %;\
    %;\
    /set cechy_brakuje 0 %;\
    /set cechy_licznik 0 %;\
